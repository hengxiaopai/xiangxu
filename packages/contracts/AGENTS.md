...
- Gate 4.2 Stage 1 permits additive Library, Knowledge Overview, CreateLibrary, `GET /knowledge/overview`, and `GET/POST /libraries` contracts plus the `knowledge` projection hint.
